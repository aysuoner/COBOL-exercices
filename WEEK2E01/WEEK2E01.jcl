//BDCALCU JOB 1,NOTIFY=&SYSUID
//***************************************************/
//COBRUN   EXEC PROC=IGYWCL
//COBOL.SYSIN  DD DSN=&SYSUID..CBL(WEEK2E01),DISP=SHR
//LKED.SYSLMOD DD DSN=&SYSUID..LOAD(WEEK2E01),DISP=SHR
//***************************************************/
// IF RC < 5 THEN
//***************************************************/
...
//             DISP=(NEW,CATLG,DELETE),
//             SPACE=(TRK,(5,5),RLSE),
//             DCB=(RECFM=FB,LRECL=59,BLKSIZE=0),UNIT=3390
//CEEDUMP   DD DUMMY
//SYSUDUMP  DD DUMMY
//***************************************************/
// ELSE
